...
INSERT INTO USUARIO_POSSUI_PERFIL
    (USUARIO_ID, PERFIL_ID)
VALUES
    ((SELECT US_LOGIN FROM USUARIO WHERE US_LOGIN='biamarou@gmail.com'), (SELECT PE_ID FROM PERFIL WHERE PE_NOME='CUSTOS')),
    ((SELECT US_LOGIN FROM USUARIO WHERE US_LOGIN='biamarou@gmail.com'), (SELECT PE_ID FROM PERFIL WHERE PE_NOME='ALUMNUS')),
    ((SELECT US_LOGIN FROM USUARIO WHERE US_LOGIN='leolanavo@gmail.com'), (SELECT PE_ID FROM PERFIL WHERE PE_NOME='ADMINISTRATOR')),
    ((SELECT US_LOGIN FROM USUARIO WHERE US_LOGIN='leolanavo@gmail.com'), (SELECT PE_ID FROM PERFIL WHERE PE_NOME='ADMINISTRATOR')),
    ((SELECT US_LOGIN FROM USUARIO WHERE US_LOGIN='leolanavo@gmail.com'), (SELECT PE_ID FROM PERFIL WHERE PE_NOME='ANALYTICUM'));
...
VALUES
    ((SELECT AL_ID FROM ALUNO WHERE AL_NUSP='9793735'), (SELECT DS_ID FROM DISCIPLINA WHERE DS_CODIGO='MAC0350'), 1, 2018, 2),
    ((SELECT AL_ID FROM ALUNO WHERE AL_NUSP='9793735'), (SELECT DS_ID FROM DISCIPLINA WHERE DS_CODIGO='MAC0218'), 1, 2018, 0),
    ((SELECT AL_ID FROM ALUNO WHERE AL_NUSP='9793735'), (SELECT DS_ID FROM DISCIPLINA WHERE DS_CODIGO='MAC0460'), 1, 2018, 2),
    ((SELECT AL_ID FROM ALUNO WHERE AL_NUSP='9793652'), (SELECT DS_ID FROM DISCIPLINA WHERE DS_CODIGO='MAC0328'), 1, 2018, 2),
    ((SELECT AL_ID FROM ALUNO WHERE AL_NUSP='9793652'), (SELECT DS_ID FROM DISCIPLINA WHERE DS_CODIGO='MAC0218'), 1, 2018, 0);
